package com.minaryanshofa.latihanpojo;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_move_with_data_activity:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Minaryan Shofa");
            ...
            case R.id.btn_move_activity_object:
                ...
                mPerson.setName("Minaryan Shofa");
                mPerson.setAge(17);

                mPerson.setEmail("1920118113.siswa@smkn4bdg.sch.id");
            ...
            case R.id.btn_dial_number:
                String phoneNumber = "081528704909";
